  ...
  if (isLoading) {
    return (
      <div className="p-8">
        ...
        <SkeletonCard count={4} height={96} variant="stat" />
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 min-h-[300px] mt-8 flex items-center justify-center text-gray-400">
