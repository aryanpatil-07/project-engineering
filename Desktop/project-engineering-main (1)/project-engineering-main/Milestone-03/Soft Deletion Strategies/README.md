...
- `DELETE /users/:id`: Soft-delete a user account from the system.
...
- `DELETE /accounts/:id`: Soft-delete an account from the database.
...
- `DELETE /transactions/:id`: Soft-delete a transaction record.

### 🧾 Audit

- `GET /audit/deleted-records`: Review soft-deleted users, accounts, and transactions.
